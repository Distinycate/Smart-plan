...
9. competencies: (วิเคราะห์สมรรถนะสำคัญผู้เรียนที่เน้นในแผนนี้ เช่น - ความสามารถในการสื่อสาร\n- ความสามารถในการคิด)
10. desiredAttributes: (วิเคราะห์คุณลักษณะอันพึงประสงค์ เช่น - มีวินัย\n- ใฝ่เรียนรู้\n- มุ่งมั่นในการทำงาน)
11. skills21: (วิเคราะห์ทักษะศตวรรษที่ 21 เช่น - Critical Thinking\n- Collaboration)
...
15. learningProcess: (วิธีดำเนินกิจกรรมการเรียนรู้แบบ Active Learning โดยแบ่งขั้นตอนการสอนให้ชัดเจนเป็น 5 ขั้นตอน ได้แก่: 1. ขั้น Warm-up, 2. ขั้น Presentation, 3. ขั้น Practice, 4. ขั้น Production, 5. ขั้น Wrap-up โดยแต่ละขั้นระบุบทบาทครูและนักเรียนให้ชัดเจน)
