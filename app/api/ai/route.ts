...
11. เกณฑ์ Rubric ประเมินผล (rubricK, rubricP, rubricA) ต้องเขียนให้ครบทั้ง 5 ระดับ (5=ดีเยี่ยม, 4=ดีมาก, 3=ดี, 2=พอใช้, 1=ปรับปรุง) ห้ามเขียนข้ามระดับ ห้ามรวบรัด และต้องอธิบายคุณภาพงานในแต่ละระดับให้ชัดเจน
...
20. rubricK: (คำอธิบายเกณฑ์ Rubric K แบ่งเป็น 5 ระดับอย่างละเอียด: 5, 4, 3, 2, 1 ห้ามตัดตอน)
21. measureP: (สิ่งที่ต้องการวัดและประเมินผล P)
22. methodP: (วิธีการวัด P)
23. toolP: (เครื่องมือวัด P)
24. criteriaP: (เกณฑ์ประเมิน P)
25. rubricP: (คำอธิบายเกณฑ์ Rubric P แบ่งเป็น 5 ระดับอย่างละเอียด: 5, 4, 3, 2, 1 ห้ามตัดตอน)
26. measureA: (สิ่งที่ต้องการวัดและประเมินผล A)
27. methodA: (วิธีการวัด A)
28. toolA: (เครื่องมือวัด A)
29. criteriaA: (เกณฑ์ประเมิน A)
30. rubricA: (คำอธิบายเกณฑ์ Rubric A แบ่งเป็น 5 ระดับอย่างละเอียด: 5, 4, 3, 2, 1 ห้ามตัดตอน)
