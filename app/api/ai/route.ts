...
20. measureP: (สิ่งที่ต้องการวัดและประเมินผล ด้านทักษะกระบวนการ P เช่น ทักษะการฟังและการพูดบทสนทนา, ความถูกต้องในการเขียนประโยค)
21. methodP: (วิธีการวัด ด้าน P เช่น การประเมินทักษะพูด)
22. toolP: (เครื่องมือวัด ด้าน P เช่น แบบประเมินภาระงาน)
23. criteriaP: (เกณฑ์ประเมิน ด้าน P เช่น ผ่านเกณฑ์ระดับคุณภาพดีขึ้นไป)
24. measureA: (สิ่งที่ต้องการวัดและประเมินผล ด้านคุณลักษณะ A เช่น ความมีวินัย, ความใฝ่เรียนรู้)
25. methodA: (วิธีการวัด ด้าน A เช่น การสังเกตพฤติกรรม)
26. toolA: (เครื่องมือวัด ด้าน A เช่น แบบประเมินคุณลักษณะ)
27. criteriaA: (เกณฑ์ประเมิน ด้าน A เช่น ผ่านเกณฑ์ระดับคุณภาพดีขึ้นไป)
28. resultK: (จำลอง "ผลการจัดการเรียนรู้" หลังสอนเสร็จ ด้าน K เพื่อให้ครูดูเป็นแนวทาง เช่น นักเรียนร้อยละ 85 เข้าใจคำศัพท์...)
29. resultP: (จำลอง "ผลการจัดการเรียนรู้" ด้าน P เช่น นักเรียนส่วนใหญ่พูดสื่อสารได้ดี มีบางส่วนต้องพัฒนาเพิ่มเติม...)
30. resultA: (จำลอง "ผลการจัดการเรียนรู้" ด้าน A เช่น นักเรียนใฝ่เรียนรู้และให้ความร่วมมือในการทำงานกลุ่ม...)
31. problems: (จำลอง "ปัญหาและอุปสรรค" ที่อาจพบในการสอนเรื่องนี้ เช่น นักเรียนบางคนสมาธิสั้นหรือจำคำศัพท์ไม่ได้...)
32. solutions: (จำลอง "แนวทางแก้ไขและการพัฒนา" เพื่อเป็นแนวทางให้ครู เช่น จัดกิจกรรมกลุ่มคละความสามารถ...)`;
