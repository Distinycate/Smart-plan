...
20. rubricK: (เกณฑ์การให้คะแนนแบบ Rubric ด้านความรู้ K เช่น ระดับ 3 = ตอบถูกต้อง 80% ขึ้นไป, ระดับ 2 = ตอบถูกต้อง 60-79%, ระดับ 1 = ตอบถูกต้องต่ำกว่า 60%)
...
25. rubricP: (เกณฑ์การให้คะแนนแบบ Rubric ด้านทักษะกระบวนการ P เช่น ระดับ 3 = พูดสื่อสารได้คล่องแคล่วและถูกต้องตามหลักไวยากรณ์, ระดับ 2 = พูดสื่อสารได้แต่มีข้อผิดพลาดบางจุด, ระดับ 1 = พูดสื่อสารได้น้อยมากหรือติดขัดมาก)
...
30. rubricA: (เกณฑ์การให้คะแนนแบบ Rubric ด้านคุณลักษณะ A เช่น ระดับ 3 = ตั้งใจเรียน ส่งงานตรงเวลา และมีพฤติกรรมใฝ่รู้สม่ำเสมอ, ระดับ 2 = ส่งงานตรงเวลาแต่ขาดการมีส่วนร่วมบางครั้ง, ระดับ 1 = ไม่ส่งงานตามกำหนดและขาดความกระตือรือร้น)
