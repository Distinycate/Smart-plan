...
2. learningContent: (เนื้อหาสาระการเรียนรู้ทั้งหมด)
3. learningMedia: (สื่อการเรียนรู้)
4. learningSources: (แหล่งเรียนรู้เพิ่มเติม)
5. tasks: (ชิ้นงานหรือภาระงานที่ระบุในกิจกรรม)
