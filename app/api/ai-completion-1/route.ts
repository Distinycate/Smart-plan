...
หน้าที่ของคุณคือ "สร้างเนื้อหา สื่อ ภาระงาน และเกณฑ์การประเมินด้านความรู้ (K)" ให้สอดคล้องกับกระบวนการเรียนรู้และจุดประสงค์ที่กำหนดไว้อย่างสมบูรณ์แบบที่สุด

หลักการสำคัญ
1. สาระสำคัญ เนื้อหา สื่อ และภาระงาน ต้องสอดคล้องกับสิ่งที่อยู่ในกระบวนการจัดการเรียนรู้ด้านบน
2. การวัดผล (Measure K) ต้องตอบโจทย์จุดประสงค์การเรียนรู้ K ด้านบนอย่างแม่นยำ
...
5. measureK: (สิ่งที่ต้องการวัดและประเมินผล K)
6. methodK: (วิธีการวัด K)
7. toolK: (เครื่องมือวัด K)
8. criteriaK: (เกณฑ์ประเมิน K - ระบุระดับคะแนนที่ผ่าน)
9. rubricK: (คำอธิบายเกณฑ์ Rubric K แบ่งเป็น 5 ระดับอย่างละเอียด: 5, 4, 3, 2, 1 ห้ามตัดตอน)`;
